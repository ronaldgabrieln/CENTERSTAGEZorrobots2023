...
public class ZorroAutoBlueLONG extends LinearOpMode {
    //Garras
    ...
    public void runOpMode() throws InterruptedException {
        ...
        rightPlacement =  drive.trajectoryBuilder(startPose)
                .forward(35)
                .build();
        rightAdjustToPurpleRight= drive.trajectoryBuilder(leftPlacement.end().plus(new Pose2d(0,0,Math.toRadians(90))), false)
                .forward(3)
                .build();
        ...
        while(opModeIsActive() && !isStopRequested()) {
            telemetry.addData("Brazo: ", Brazo.getCurrentPosition());
                if (direccion == 0) {
                    ...
                    GarraIzq.setPosition(.7);
                    sleep(1000);
                    GarraDer.setPosition(.7);
                    sleep(1000);
